...
<?php $query_subcat2="select * from subcategory2 where sub_cat2_id='$sub2_catid'";
	$data_subcat2=fetch_query($con,$query_subcat2);
	$sub2_catid=$data_subcat2[0]["sub_cat2_id"];
	$sub1_catid=$data_subcat2[0]["sub_cat_id"];
	$catid=$data_subcat2[0]["cat_id"];
...
<div class="content indent" ><br>
	<div class="container">
		<div class=" col-md-12  wow fadeIn" style="border: 1px solid #DFDFDF; padding:25px;">
				...
				<?php  echo ucwords( $data_subcat[0]['sub_cat_name']);  ?> > <?php  echo ucwords( $data_subcat2[0]['sub_cat2_name']);  ?> </h5><br>
					<div class="row">
<!-- div1 start--===========================================================================================--->
<?php $type=3;include 'includes/left-bar-category.php'; ?>
	
  	<!--span style="font-size:14px; color:gray;" ><?php    $data_subcat[0]['sub_cat_name'];  ?></span-->		
	<div class="col-md-9 wow fadeIn" data-wow-delay="0.1s" id="ifYes1<?php echo $data_cat['category_id']; ?>"  style=" border:1px solid #DFDFDF; background-color:#FAFAFA;  color:#699E1E;  " >
		...
		<?php 
	  $product="select * from product where   subcategory2='".$about_data['sub_cat2_id']."'";
