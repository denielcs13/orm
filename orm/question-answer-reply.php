...
<div class="content indent">
  <div class="thumb-box4" >
		<div class="container">
			<h3 class="indent2 wow fadeIn"><center>Ask Questions</center></h3>
				<div  class="col-md-12 contactForm2" style="background-color:#ffffff; width:100%;  border:1px solid lightgray; padding:10px;">
					<div class="col-md-10"> <h4>Question & Answers</h4> </div> <div class="col-md-2">
						</div>
<!-- question stat--    ///////////////////////////////////////////////////////////////////////////////     ---->
...
$sql=mysqli_query($con,"SELECT user_register.u_id,  question.q_id, user_register.u_image, user_register.u_name, question.q_name, question.q_date from user_register  JOIN question ON user_register.u_id= question.user_id order by q_id DESC");
$qcount=1;
...
<div class="col-md-12" style="border:1px solid lightgray; margin-bottom:10px; padding:5px;">
  <div class="row">
	...
	<div class="col-md-8"><a href="qad/<?php echo $data["q_id"].'/'.strtolower(str_replace(" ","-",$data["q_name"])).'-'.'1.html'; ?>" style="color:green;"><?php echo $data['q_name']; ?> </span><br>
...
<div class="col-md-12" >
  ...
  <?php if($aresult1['u_image'] == '')  { ?>
					...
					<div class="col-md-8" >			
					ANSWER:<span style="color:green;"><?php echo $aresult['answer']; ?></span><br>
...
<div class="col-md-8" id="myDIV<?php echo $aresult['ans_id'];  ?>" style="display:none; background-color:#FAFAFA;       margin-left: 175px; margin-top:5px; padding:5px;">
	...
	<?php $qcount++;  } ?>
	<div class="col-md-12"  id="div2" style=" border:1px solid lightgray; background-color:#FAFAFA; margin-bottom:10px; padding:15px;">
		...
		<div class="contact-form-loader"></div>
			...
			<label class="name form-div-4">
				<strong>Question:</strong>
					...
					<input type="hidden" name="product_id" value=""/>	
					<input type="hidden" name="customer_id" id="customer_id" value="<?php echo $review_customer_id; ?>"/>
					<input type="text" name="q_name" id="q_name" style="background-color:white;" required />
					
			</label>	<br>
			<? include 'includes/captcha.php'; ?>
						<br>
			
		<a style="background-color:red; padding:6px; color:white; border-radius:8px;float:right;"  name="submit" id="add_data_question" <?php  echo  ($review_customer_id=='')?'data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false" data-type="submit"':''; ?>>Ask a Question</a>
...
<script>
/* ClassicEditor
        .create( document.querySelector( 'textarea#q_name' ) ).then( newEditor => {
        editor = newEditor;
    } ) .catch( error => {
            console.error( error );
        } ); */

/* var allEditors = document.querySelectorAll('textarea#a_name');
...
<script>
 $(document).ready(function(){
   ...
   function myFunction(id) {	 
	...
	//$("#q_name").val(editor.getData())	
	var q_name=$("#q_name").val();	
	 if(q_name=='' || q_name=='<p></p>' || q_name=='<p> </p>' || q_name=='<p>&nbsp;</p>' || q_name=='<p>  </p>'){
