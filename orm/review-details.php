...
<div class="content indent">
  ...
  <table class="table">
	...
	<?php 
 $query=mysqli_query($con,"Select * from `review` where user_id='$id'");
 $i=1;
 ...
 {	
    ...
    <tbody>
      <tr>
        <td><?php echo $i; ?></td>
        <td><?php  echo $data['r_title']; ?></td>
        <td><?php  echo $data['r_description']; ?></td>
        <td><?php echo $data['r_rating']; ?>  <i class="fa fa-star"></i></td>
       <td>
